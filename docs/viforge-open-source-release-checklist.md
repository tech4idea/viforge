...
仓库主 license 已定为 MIT License，并在仓库根目录提供 `LICENSE`。根目录 `NOTICE` 记录 ViForge 项目 attribution，`THIRD_PARTY_NOTICES.md` 记录 P0 发布需要随安装包关注的第三方组件和二进制分发边界。
