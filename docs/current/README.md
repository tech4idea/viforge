...
- [22 项目架构图 Markdown 草稿](./22-project-architecture-wireframe.md)
- [23 Agent Harness 当前功能边界](./23-agent-harness-functional-boundary.md)
- [24 Markdown 文档批注功能设计](./24-markdown-annotation-design.md)
- [25 Agent Harness RuntimeConfig PRD](./25-agent-harness-runtime-config-prd.md)
- [26 Agent Harness RuntimeConfig 交互逻辑稿](./26-agent-harness-runtime-config-interaction.html)
