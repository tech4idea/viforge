...
Release packaging runs `pnpm --filter @viforge/desktop prepare:git` and fails if the target bundle is missing. Set `VIFORGE_GIT_BUNDLE_SOURCE` to copy a prepared portable Git distribution into the expected platform directory before packaging.
